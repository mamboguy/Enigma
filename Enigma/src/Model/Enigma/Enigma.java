...
//            temp[i] = rotorsAvailable.get(i).getName();
//        }
//
//        return temp;
//    }
...
//                if (rotorsAvailable.get(j).getName().equalsIgnoreCase(rotors[k])) {
...
//            rotorsUsed.add(null);
//        } else {
//            if (!rotorsUsed.get(location).getName().equals(rotorName)) {
//                for (int i = 0; i < rotorsAvailable.size(); i++) {
//                    if (rotorsAvailable.get(i).getName().equalsIgnoreCase(rotorName)) {
