 ...
 */
@Deprecated
public class HistoricalRotorDeprecated implements IRotor {
...
//<editor-fold desc="Constructors">
    ...
    public HistoricalRotorDeprecated(String rotorName, String wiringSequence, String notchLocation, int usage) {
        this(rotorName, wiringSequence, notchLocation, usage, 'A', 'A');
    }

    //Detailed rotor constructor
    public HistoricalRotorDeprecated(String rotorName, String wiringSequence, String notchLocation, int usage, char labelPosition, char keyPosition) {
...
//</editor-fold>
    ...
    public String toString() {
        ...
        return "HistoricalRotorDeprecated{" + "rotorName=" + rotorName + ", baseWiringSequence=" + baseWiringSequence + ", notchLocation= "
    ...
    public void printRotor() {
        System.out.println("HistoricalRotorDeprecated = " + this.toString());
    }
